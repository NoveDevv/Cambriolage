        ...
        RMenu.Add("telescope", "script_main", RageUI.CreateMenu("Cambriolage","Prendre le telescope !!"))
        ...
        RageUI.IsVisible(RMenu:Get("telescope","script_main"),true,true,true,function() 
            ...
            RageUI.ButtonWithStyle("Prendre l'objet", nil, {RightLabel = "Récompense : ~g~700$"}, not cooldown,function(h,a,s)
                if s then
                    ...
                    ESX.ShowAdvancedNotification("Cambriolage ", "~r~Cambriolage !","Gg tu a recupere ~g~700 $~s~, continue comme sa !" , "CHAR_LESTER_DEATHWISH", 24,5)
                end
            end)
