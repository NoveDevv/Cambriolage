        ...
        RMenu.Add("livre", "script_main", RageUI.CreateMenu("Cambriolage","Prendre les livres !!"))
            ...
            RageUI.ButtonWithStyle("Prendre l'objet", nil, {RightLabel = "Récompense : ~g~50$"}, not cooldown,function(h,a,s)
                if s then
                   ...
                   Citizen.SetTimeout(20000,function()
                    ...
                    ESX.ShowAdvancedNotification("Cambriolage ", "~r~Cambriolage !","Gg tu a recupere ~g~50 $~s~, continue comme sa !" , "CHAR_LESTER_DEATHWISH", 24,5)
                end
          end)
